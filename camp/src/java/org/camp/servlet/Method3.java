...
public class Method3 extends HttpServlet {
    void multiplication(int a,int b,boolean c,PrintWriter d){
        int ans;
        ans=a*b;
        if(c==true){
            ans=ans*ans;
    ...
    void multiplication(boolean a,PrintWriter d){
        multiplication(10,10,a,d);
    }
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            multiplication(10,10,true,out);
            multiplication(10,10,false,out);
